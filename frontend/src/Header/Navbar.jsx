...
export default function Navbar() {
  ...
  // Logout handler clears auth info and redirects to home or signin
  const handleLogout = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <Link
              to="/signin"
              className="px-8 py-3 rounded-3xl bg-blue-700 text-white font-bold shadow-lg hover:bg-green-800 transition-colors"
            >
              Sign In
            </Link>
            ...
            <button
              ...
              className="px-6 py-2 rounded-3xl bg-gray-700 text-white font-bold shadow-lg hover:bg-gray-800 transition-colors"
            >
              Logout
            </button>
          </div>
        ...
        <div className="md:hidden bg-gray-800" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <button
              ...
              className="w-full text-left block px-3 py-2 rounded-md text-base font-medium bg-gray-700 text-white hover:bg-gray-800 transition-colors"
            >
              Logout
            </button>
          </div>
